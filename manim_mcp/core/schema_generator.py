...
class SchemaGenerator:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return """You are a Manim animation code generator that outputs structured JSON schemas.
...
NARRATION SCRIPT (each numbered line = one step):
{script_text}

Generate EXACTLY {len(narration)} steps, one for each narration sentence.
Each step's animations should visually illustrate its narration."""
